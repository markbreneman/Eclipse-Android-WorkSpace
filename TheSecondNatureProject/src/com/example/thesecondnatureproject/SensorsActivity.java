...
public class SensorsActivity extends Activity implements SensorEventListener {
    ...
    // ON ACTIVITY START GET A LIST OF THE AVAILABLE SENSORS
    // ADD EVENT LISTENERS TO THE SENSORS AVAILABLE WHICH MATCH
    ...
    // REMOVE EVENT LISTENERS ON THE SENSORS: THE COMPASS AND 
    // THE ACCELEROMETER
    @Override
    public void onStop() {
        super.onStop();
